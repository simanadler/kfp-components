...
#
 ...
 #       endpoint_dict[namespace + "/" + test_data] = test_url
    ...
    return train_endpoint, test_endpoint
...
if __name__ == '__main__':
    ...
    if (succeeded):
        train_endpoint, test_endpoint = getEndpoints(args.run_name, args.train_dataset_id, args.test_dataset_id, k8s_api, args.namespace)

        print("train_endpoint: ", train_endpoint)
        print("test_endpoint: ", test_endpoint)
